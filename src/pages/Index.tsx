...
const toolCategories = [
  {
    ...
    tools: [
      ...
      { icon: Minimize2, title: 'Compress PDF', desc: 'Reduce file size by stripping metadata.', path: '/compress', color: 'bg-tool-emerald/15 text-tool-emerald' },
      { icon: Palette, title: 'Grayscale PDF', desc: 'Convert color PDFs to grayscale.', path: '/grayscale', color: 'bg-tool-cyan/15 text-tool-cyan' },
      { icon: RotateCw, title: 'Rotate Pages', desc: 'Rotate PDF pages 90°, 180°, or 270°.', path: '/rotate', color: 'bg-tool-amber/15 text-tool-amber' },
      { icon: Trash2, title: 'Delete Pages', desc: 'Remove specific pages from any PDF.', path: '/delete-pages', color: 'bg-tool-rose/15 text-tool-rose' },
      { icon: FileOutput, title: 'Extract Pages', desc: 'Pull specific pages into a new document.', path: '/extract-pages', color: 'bg-tool-pink/15 text-tool-pink' },
      { icon: Droplets, title: 'Add Watermark', desc: 'Stamp text watermarks on every page.', path: '/add-watermark', color: 'bg-tool-teal/15 text-tool-teal' },
      { icon: Lock, title: 'Encrypt PDF', desc: 'Add password protection to PDFs.', path: '/encrypt', color: 'bg-tool-indigo/15 text-tool-indigo' },
      { icon: Unlock, title: 'Unlock PDF', desc: 'Remove restrictions from PDFs.', path: '/unlock-pdf', color: 'bg-tool-rose/15 text-tool-rose' },
      { icon: Hash, title: 'Page Numbers', desc: 'Add sequential page numbers.', path: '/page-numbers', color: 'bg-tool-amber/15 text-tool-amber' },
      { icon: Layers, title: 'Flatten PDF', desc: 'Remove form fields and annotations.', path: '/flatten', color: 'bg-tool-teal/15 text-tool-teal' },
      { icon: Layers, title: 'Reorder Pages', desc: 'Drag & drop to rearrange pages.', path: '/reorder-pages', color: 'bg-tool-violet/15 text-tool-violet' },
  ...
  },
  {
    ...
    tools: [
      ...
      { icon: ArrowRightLeft, title: 'Word to PDF', desc: 'Convert Word documents to PDF.', path: '/word-to-pdf', color: 'bg-tool-indigo/15 text-tool-indigo' },
      { icon: Code, title: 'XML to PDF/Word', desc: 'Parse XML into formatted documents.', path: '/convert', color: 'bg-tool-lime/15 text-tool-lime' },
      { icon: Eraser, title: 'Remove Background', desc: 'AI-powered background removal.', path: '/bg-remover', color: 'bg-tool-cyan/15 text-tool-cyan' },
